...
if (!$conn) {
    ...
    $count=0;
    $answers=array("D","A","A","C","C","C","D","D","A","A");
    ...
    $sql = "INSERT INTO verbal(registrationnumber,verbal) VALUES ('$register',$count)";
    if (mysqli_query($conn, $sql)) {
    echo "successfully completed verbal exam then enter into technical test";
            
    echo "  after one minute write th test";
    ...
    header("refresh:60;url=assessmenttechnical.php");
...
window.location="assessmenttechnical.php";
</script>
    </body>
</html>
